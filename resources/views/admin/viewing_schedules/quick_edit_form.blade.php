...
@section('content')
    <div class="block">
        ...
        {!! Form::model($viewingSchedule, ['route' => ['admin.viewing_schedule.quick_edit', 'id' => $viewingSchedule->id], 'method' => 'POST', 'id' => 'viewing-schedule-quick-edit-form', 'class' => 'form-horizontal']) !!}
