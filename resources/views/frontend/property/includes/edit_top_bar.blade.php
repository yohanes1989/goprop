<div class="menu-preview">
    <ul class="list-unstyled">
        <li><a href="{{ route('frontend.property.view', ['id' => $model->id, 'preview' => TRUE, 'backUrl' => Request::path()]) }}"><img src="{{ asset('assets/frontend/images/property-preview.png') }}" alt="" /> {{ trans('property.buttons.preview') }}</a></li>
