    ...
    <div class="advanced-search-wrapper login-form-wrapper">
        <div class="col-xs-12">
            {!! Form::open(['method' => 'GET', 'route' => 'frontend.property.search']) !!}
                ...
                <div class="form-group">
                    <div>{{ trans('property.index.price_range') }}: <strong>IDR <span id="price-from">10000000</span> - IDR <span id="price-to">100000000000</span></strong></div>
                    <input type="text" id="inputPriceRange" name="search[price]" value="" data-min="10000000" data-max="100000000000"
                           data-step="50000000" data-from="10000000" data-to="100000000000" />
                </div>
                <div class="form-group">
