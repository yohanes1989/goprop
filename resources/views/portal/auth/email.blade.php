...
@section('body_content')
    <div id="login-container">
        ...
        <div id="page-content" class="block remove-margin">
            ...
            <!-- Login Form -->
            <form class="form-horizontal" role="form" method="POST" action="{{ route('portal.account.email.process') }}">
                ...
                <div class="form-group">
                    ...
                    <a href="{{ action('Portal\Auth\AuthController@getLogin') }}">Back to Login</a>
                </div>
            </form>
            <!-- END Login Form -->
        </div>
