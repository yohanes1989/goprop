...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "assets/editor/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "assets/editor/uploads";
        

    $useruploadfolder = "assets/frontend/images";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "assets/frontend/images";
